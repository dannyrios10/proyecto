    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="elimina.php">Eliminar</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="masthead">
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
		...
		<p>FOLIO: <input type="text" name="folio" required size="25" /></p>
...
if(isset($_POST['folio'])){
  ...
  $sql="DELETE FROM conferencia WHERE conferencia.folio = $id";
  if($mysqli->query($sql)==true)
  {
    
      echo '<script language="javascript">alert("Datos borrados Corectamente");</script>';
  }
  else{
    die("Error al borrar los datos " . $mysqli->error);
  }
}
